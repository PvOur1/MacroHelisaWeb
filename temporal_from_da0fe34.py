...
def macro_f3(row_dict: dict | None = None):
    ...
    pyautogui.press("enter")
    time.sleep(0.5)
    # Paso 7 + Paso 6 robustos: ejecutar la secuencia de teclas y luego intentar btn4
    def _do_step7_then_btn4_local(retries: int = 2) -> bool:
    ...
    ok = _do_step7_then_btn4_local(retries=2)
